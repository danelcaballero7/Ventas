...
{
    public class UsuarioService : IUsusarioService
    {
    ...
    public async Task<Usuario> OptenerPorId(int IdUsuario)
    {
    ...
    public async Task<bool> CambiarClave(int IdUsuario, string ClaveActual, string ClaveNueva)
    {
        try
        {
            ...
            {
                throw new TaskCanceledException("La contrasenna ingresada como actual no es correcta");
            }
    ...
    public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
    {
        try
        {
            ...
            if (htmlCorreo != "")
                correo_enviado = await _correoService.EnviarCorreo(Correo, "Contrasenna Restablecida", htmlCorreo);
